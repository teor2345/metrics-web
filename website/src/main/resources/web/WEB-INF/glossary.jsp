...
<jsp:include page="top.jsp">
  ...
  <jsp:param name="navActive" value="About"/>
    ...
    <div class="container">
      ...
      Tor network
      built by <a href="#client">clients</a>. Clients start their circuits at
      a  <a href="#bridge">bridge</a> or <a href="#relay">relay</a>.
      Anonymous circuits use additional relays to hide the source of the
      circuit.</p>
